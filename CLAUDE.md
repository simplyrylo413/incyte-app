...
- **IMPORTANT:** When a task is complete, always explicitly state the outcome — what was done, whether it worked, and what the result is. Never end a turn silently after completing work.
