...
5. **AI Apply when all done** — prototype creates a new set seeded with rec values. Production has no concept of "session extension". Does Albert want this auto-extend behavior?
